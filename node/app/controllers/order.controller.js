...
exports.findAll = async (req, res, next) => {
    ...
    try {
        ...
        return next(new ApiError(500, "Error when retrieving data"));
    }
...
exports.findOne = async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, `Error when retrieving order with id=${req.params.id}`));
    }
}
...
exports.findByUser = async (req, res, next) => {
    ...
    try {
        ...
        return next(new ApiError(500, `Error when retrieving orders for user id=${req.params.id}`));
    }
    return res.send(documents);
}
...
exports.findByStore = async (req, res, next) => {
    ...
    try {
        ...
        return next(new ApiError(500, `Error when retrieving orders for store id=${req.params.id}`));
    }
    return res.send(documents);
}
...
exports.findByUserIdAndStoreId = async (req, res, next) => {
    ...
    try {
        ...
        return next(new ApiError(500, `Error when retrieving orders for user id=${req.params.userid} and store id=${req.params.storeid}`));
    }
    return res.send(documents);
}
